...
from NJDOT_EPermitting_System.pages.submit_application.major_planning_page import MajorPlanningPage
from NJDOT_EPermitting_System.pages.submit_application.minor_access_page import MinorAccessPage
from NJDOT_EPermitting_System.pages.submit_application.highway_occupancy_page import HighwayOccupancyPage
from NJDOT_EPermitting_System.pages.submit_application.street_intersection_page import StreetIntersectionPage
from NJDOT_EPermitting_System.pages.submit_application.drainage_page import DrainagePage
from NJDOT_EPermitting_System.pages.submit_application.erection_pole_page import ErectionPolePage
...
__all__ = [
    "PermitMajorPage",
    "StreetIntersectionPage",
    "HighwayOccupancyPage",
    "DrainagePage",
    "ErectionPolePage",
