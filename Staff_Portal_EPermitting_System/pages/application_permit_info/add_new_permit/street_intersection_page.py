...
class StreetIntersectionPage(GeneralInformationPage):
    """
    Handles specialized fields and logic specifically for the 'Street Intersection' application type.
    """
    ...
    def fill_general_information(self, data: dict = None) -> None:
        """Fills the General Information section for a Street Intersection permit."""
        logger.info("Filling Street Intersection General Information section.")
        ...
        try:
            if self.design_job_input.is_visible():
                self.design_job_input.fill(data.get("project_name", "STRINT-TEST"))
    ...
    def fill_location_information(self, data: dict = None) -> None:
        ...
        logger.info("Filling Street Intersection Location Information section.")
    ...
    def save_permit(self) -> None:
        ...
        logger.info("Saving Street Intersection permit.")
        self._wait_for_loader()
        self.js_click(self.save_button)
        self._wait_for_loader()
        self.assert_no_validation_errors()

    def verify_street_intersection_details(self, data: dict = None) -> None:
        """Verifies successful permit creation."""
        self.verify_permit_saved()

    def create_street_intersection_permit(self, data: dict = None) -> None:
        """Orchestrates full Street Intersection creation flow."""
